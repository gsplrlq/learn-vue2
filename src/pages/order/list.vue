    ...
    <ul v-if="orderList.length > 0" class="order-list">
      ...
      >
        ...
        <div class="order-list-box">
          <dl>
            <dd class="order-content">
              <div class="img-box">
                <img :src="item.productImageUrl" width="160" height="90" alt="">
              </div>
              <div class="order-name-box">
                ...
                <!-- <p class="order-real-price">
                  ¥ {{ item.isDiscount ? item.discountPrice : item.amount }}
                </p> -->
              </div>
            </dd>
          </dl>
          ...
          <div class="order-status-box">
            ...
            <template v-else>
              <p class="order-status">
                {{ item.status == 2 ? '已完成' : '已关闭' }}
              </p>
              <p v-if="item.status == 2" class="order-pay">
                <!-- {{ item.way.text }} -->
              </p>
            </template>
          </div>
